    ...
    return (
      <div className="w-full bg-white border-2 border-orange-400 p-3 space-y-3" id="action-ribbon">
        ...
        <div className="flex flex-wrap gap-2">
          <button type="button" onClick={() => { onMode("search"); onTarget("all"); }} className={`px-3 py-2 text-xs font-black uppercase border cursor-pointer ${mode === "search" && target === "all" ? "bg-orange-600 text-white border-orange-600" : "bg-white border-slate-400"}`}>Look around</button>
          <button type="button" onClick={() => { onMode("show"); onTarget("all"); }} className={`px-3 py-2 text-xs font-black uppercase border cursor-pointer ${mode === "show" ? "bg-orange-600 text-white border-orange-600" : "bg-white border-slate-400"}`}>Show my work</button>
          <button type="button" onClick={() => { onMode("ask"); onTarget("all"); }} className={`px-3 py-2 text-xs font-black uppercase border cursor-pointer ${mode === "ask" ? "bg-orange-600 text-white border-orange-600" : "bg-white border-slate-400"}`}>Ask for work</button>
          <button type="button" onClick={() => { onMode("search"); onTarget("moniker"); }} className={`px-3 py-2 text-xs font-black uppercase border cursor-pointer ${target === "moniker" ? "bg-orange-600 text-white border-orange-600" : "bg-white border-slate-400"}`}>Find a name</button>
          <button type="button" onClick={() => onTarget("private")} className={`px-3 py-2 text-xs font-black uppercase border cursor-pointer ${target === "private" ? "bg-orange-600 text-white border-orange-600" : "bg-white border-slate-400"}`}>Private chat</button>
        </div>
        <input
